...
log("Missing predominantly contact measures - likely mostly planned missingness - e.g., friends_frequency missing when friends_count = 0. Due to residualised data, this cannot be assessed directly. Only max 0.22% missing data on attitude measures.

Paper is running CFA with listwise deletion - highly problematic with planned missingness.

Dropping cases with all contact measures missing (apart from frequency); not imputing contact_friends_frequency, not using it for imputations.
")
